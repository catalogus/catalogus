...
import { u as useAuth, q as Route$i } from "./router-BiReTygo.mjs";
...
function SignInPage() {
  ...
  return /* @__PURE__ */ jsx("div", { className: "min-h-screen flex items-center justify-center bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900 px-6", children: /* @__PURE__ */ jsxs("div", { className: "w-full max-w-md bg-white/90 backdrop-blur-sm rounded-3xl shadow-xl p-8", children: [
    /* @__PURE__ */ jsxs("div", { className: "mb-6 text-center", children: [
      ...
      /* @__PURE__ */ jsx("h1", { className: "mt-4 text-2xl font-semibold text-gray-900", children: "Sign in to Catalogus" }),
      /* @__PURE__ */ jsx("p", { className: "text-sm text-gray-500", children: "Access the admin dashboard and manage content." })
    ] }),
    /* @__PURE__ */ jsxs("form", { className: "space-y-4", onSubmit: handleSubmit, children: [
      ...
      /* @__PURE__ */ jsx("button", { type: "submit", disabled: loading || submitting, className: "w-full rounded-xl bg-black text-white py-3 text-sm font-semibold hover:bg-gray-900 disabled:opacity-60 disabled:cursor-not-allowed", children: submitting ? "Signing in..." : "Sign in" })
    ] }),
    /* @__PURE__ */ jsxs("p", { className: "mt-4 text-center text-sm text-gray-500", children: [
      "Need an account?",
      " ",
      /* @__PURE__ */ jsx(Link, { to: "/auth/sign-up", className: "font-semibold text-gray-900 underline", children: "Sign up" })
    ] })
  ] }) });
}
export {
