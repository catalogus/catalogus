  ...
  return /* @__PURE__ */ jsx(AdminGuard, { children: /* @__PURE__ */ jsx(DashboardLayout, { userRole: profile?.role ?? "admin", userName, userEmail, onSignOut: signOut, children: /* @__PURE__ */ jsxs("div", { className: "space-y-3", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
      /* @__PURE__ */ jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsx("h1", { className: "text-2xl font-semibold text-gray-900", children: "Services" })
      ] }),
      /* @__PURE__ */ jsx("button", { className: "px-4 py-2 rounded-full bg-black text-white text-sm", children: "Add service" })
    ] }),
    /* @__PURE__ */ jsx("div", { className: "rounded-2xl border border-dashed border-gray-300 p-6 text-gray-500 text-sm", children: "Services list and descriptions will be managed here." })
  ] }) }) });
}
export {
  AdminServicesPage as component
};
