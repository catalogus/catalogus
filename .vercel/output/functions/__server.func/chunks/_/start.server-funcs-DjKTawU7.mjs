...
const getTodos_createServerFn_handler = createServerRpc("c9d51a5243700889c80f82ed57a4ce74b25f188e5ebd534c9c64965dc44e8e8d", (opts, signal) => getTodos.__executeServer(opts, signal));
const getTodos = createServerFn({
  method: "GET"
}).handler(getTodos_createServerFn_handler, async () => await readTodos());
const addTodo_createServerFn_handler = createServerRpc("34a400ef155cae4517b50b99a6f1db6819e2090dea5a8bc25de22b442e6347a4", (opts, signal) => addTodo.__executeServer(opts, signal));
