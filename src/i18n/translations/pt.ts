const pt = {
  ...
  orders: {
    ...
    detail: {
      ...
      awaitingPaymentTitle: 'Aguardando confirmacao do pagamento',
      paymentFailedTitle: 'Pagamento nao confirmado',
      customer: 'Cliente',
      items: 'Itens',
      total: 'Total',
      ...
      paymentPending:
        'Enviamos um pedido para o seu M-Pesa. Confirme no telefone usando o seu PIN. Aguarde nesta pagina enquanto validamos o pagamento automaticamente.',
      ...
      receiptInstruction:
        'Descarregue ou imprima o recibo e apresente-o na nossa loja para levantar o livro.',
      print: 'Descarregar recibo',
